Rem   Sporting_Goods Database with no constraints
Rem
Rem 
Rem  SCRIPT - FUNCTION
...
INSERT INTO s_emp VALUES ('4', 'Quentin', 'Mark','quentiml',TO_DATE('07-APR-1990','DD-MON-YYYY'),NULL,'1', 'VP, Finance', '10', 2450, NULL);
INSERT INTO s_emp VALUES ('5', 'Roper', 'Joseph','roperjm',TO_DATE('04-MAR-1990','DD-MON-YYYY'),NULL,'1', 'VP, Administration', '50', 2550, NULL);
INSERT INTO s_emp VALUES ('6', 'Brown', 'Molly','brownmr',TO_DATE('18-JAN-1991','DD-MON-YYYY'),NULL,'2', 'Warehouse Manager', '41', 1600, NULL);
...
INSERT INTO s_emp VALUES ('8', 'Burns', 'Ben','burnsba',TO_DATE('07-APR-1990','DD-MON-YYYY'),NULL,'2', 'Warehouse Manager','43', 1500, NULL);
...
CREATE TABLE s_item 
(ord_id               VARCHAR2(6) CONSTRAINT s_item_ord_id_nn NOT NULL,
...
prompt
prompt Creation and population of database w/o constraints has been completed.
set feedback on
