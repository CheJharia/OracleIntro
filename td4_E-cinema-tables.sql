...
--
--  NAME
--    td4_E-cinema-tables.sql;
--
-- DESCRIPTION
--   This script contains the DDL and DLM of for cinema situation.
--    5 associated tables: play, porjection, film, individual, cinema
--  USAGE
--       SQL> START <filepath>td4_E-cinema-tables.sql
--
--
