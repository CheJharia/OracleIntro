...
: If using ORACLE, remove the UNIQUE keyword from the tow statements below.
...
CONSTRAINT INV_CK1 CHECK (INV_DATE > TO_DATE('01-JAN-2006','DD-MON-YYYY')));
...
: ORACLE users should use 'DD-MON-YY', i.e. '03-NOV-05'

INSERT INTO PRODUCT
VALUES ('11QER/31','Power painter, 15 psi., 3-nozzle','03-NOV-05',8,5,109.99,0.00,21225);

-- Insert with null attribute

INSERT INTO PRODUCT
VALUES ('BRT-345','Titanium drill bit', '18-OCT-05', 75, 10, 4.50, 0.06, NULL);
...
: Oracle date format '18-JAN-2006'
